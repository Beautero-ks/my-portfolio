...
projects: Projects[] = [
    {
      ...
      githubUrl: 'https://github.com/Beautero-ks/Eseay-Market-Frontend',
      status: 'in-progress',
      rating: 4.8,
      duration: '1 months',
      teamSize: 'Solo',
    ...
    },
    {
      ...
      githubUrl: 'https://github.com/Beautero-ks/momentora',
      status: 'in-progress',
      rating: 4.4,
      duration: '1 months',
      teamSize: 'Solo',
    ...
    },
    {
      ...
      githubUrl: 'https://github.com/Beautero-ks/BUSY Bar - Productivity Device',
      status: 'completed',
      rating: 4.6,
      duration: '3 days',
      teamSize: 'Solo',
